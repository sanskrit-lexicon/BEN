...
- [Страница 01 — A SANSKRIT-ENGLISH DICTIONARY (vol. 1)](#страница-01-a-sanskrit-english-dictionary-vol-1)
- [Страница 02 — PREFACE. (vol. 1)](#страница-02-preface-vol-1)
- [Страница 03 — CONTRACTIONS AND SIGNS. (vol. 1)](#страница-03-contractions-and-signs-vol-1)

---

## Страница 01 — A SANSKRIT-ENGLISH DICTIONARY (vol. 1)

<sub>Источник (скан): [(html text layer; no per-page PNG for ben)](https://sanskrit-lexicon.uni-koeln.de/scans/csldev/csldoc/build/dictionaries/prefaces/benpref.html#a-sanskrit-english-dictionary)</sub>

С ОТСЫЛКАМИ К ЛУЧШИМ ИЗДАНИЯМ

САНСКРИТСКИХ АВТОРОВ И ЭТИМОЛОГИЯМИ

И СОПОСТАВЛЕНИЯМИ РОДСТВЕННЫХ СЛОВ ГЛАВНЫМ ОБРАЗОМ В
...
<sub>Источник (скан): [(html text layer; no per-page PNG for ben)](https://sanskrit-lexicon.uni-koeln.de/scans/csldev/csldoc/build/dictionaries/prefaces/benpref.html#preface)</sub>
...
## Страница 03 — CONTRACTIONS AND SIGNS. (vol. 1)

<sub>Источник (скан): [(html text layer; no per-page PNG for ben)](https://sanskrit-lexicon.uni-koeln.de/scans/csldev/csldoc/build/dictionaries/prefaces/benpref.html#contractions-and-signs)</sub>
...
adhy.  adhyâya.
 ...
 †  обозначает глаголы или значения, для которых нет авторитетных отсылок.

 '  когда перед словом — обозначает, что слово встречается только как последний член сложного; когда после — как первый.

 º  обозначает сокращения, которые легко восполнить из контекста.

 -  обозначает в этимологическом разборе элементы, которые следует искать в словаре; в comp. — что слово, являющееся предметом статьи, должно быть восполнено, напр. 1, A, 8, после An- следует добавить am̄ça; 51, B, 10 bel., перед -paṇa следует добавить ardha.
