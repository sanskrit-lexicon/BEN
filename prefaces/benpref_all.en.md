...
- [Page 01 — A SANSKRIT-ENGLISH DICTIONARY (vol. 1)](#page-01-a-sanskrit-english-dictionary-vol-1)
- [Page 02 — PREFACE. (vol. 1)](#page-02-preface-vol-1)
- [Page 03 — CONTRACTIONS AND SIGNS. (vol. 1)](#page-03-contractions-and-signs-vol-1)

---

## Page 01 — A SANSKRIT-ENGLISH DICTIONARY (vol. 1)

<sub>Source (scan): [(html text layer; no per-page PNG for ben)](https://sanskrit-lexicon.uni-koeln.de/scans/csldev/csldoc/build/dictionaries/prefaces/benpref.html#a-sanskrit-english-dictionary)</sub>
...
## Page 02 — PREFACE. (vol. 1)

<sub>Source (scan): [(html text layer; no per-page PNG for ben)](https://sanskrit-lexicon.uni-koeln.de/scans/csldev/csldoc/build/dictionaries/prefaces/benpref.html#preface)</sub>
...
## Page 03 — CONTRACTIONS AND SIGNS. (vol. 1)

<sub>Source (scan): [(html text layer; no per-page PNG for ben)](https://sanskrit-lexicon.uni-koeln.de/scans/csldev/csldoc/build/dictionaries/prefaces/benpref.html#contractions-and-signs)</sub>
