"""Synthetic tests for 08_markup_fix.py (BEN)."""
...
line, n = fix_trim_whitespace("<ab> word </ab>")
check("<ab> trim", line, "<ab>word</ab>")
check("<ab> trim n>=1", n>=1, True)
line, n = fix_trim_whitespace("<ab>clean</ab>")
check("<ab> no-op", line, "<ab>clean</ab>")
check("<ab> no-op n", n, 0)
